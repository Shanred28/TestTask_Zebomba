...
namespace Common.Timer.Source
{
    ...
    public static class TimerExtensions
    {
        ...
        /// <param name="onTimeRemaining"></param>
        ...
        public static void AttachTimer(this MonoBehaviour behaviour, float duration, Action onComplete,
            Action<float> onUpdate = null, Action<float> onTimeRemaining = null, bool isLooped = false, bool useRealTime = false)
        {
            Common.Timer.Source.Timer.Register(behaviour,duration, onComplete, onUpdate, onTimeRemaining,isLooped, useRealTime);
        }
    }
}
...
namespace ITools.StarterPack.CoreLogic.Tools.Timer.Example
{
    public class TestTimerBehaviour : MonoBehaviour
    {
        ...
        private Common.Timer.Source.Timer _testTimer;
        ...
        public void StartTestTimer()
        {
            ...
            _testTimer = Common.Timer.Source.Timer.Register(
                this,
                ...
                {
                    Debug.Log(string.Format("Timer ran time remaining callback: {0:F2} seconds", timeRemaining));
                },
        ...
        {
            Common.Timer.Source.Timer.Cancel(_testTimer);
        ...
        {
            Common.Timer.Source.Timer.Pause(_testTimer);
        }

        public void ResumeTestTimer()
        {
            Common.Timer.Source.Timer.Resume(_testTimer);
        }
